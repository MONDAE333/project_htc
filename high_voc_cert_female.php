...
// กำหนดเงื่อนไขในการแสดงสินค้าตาม product_id ที่ระบุ
$query = "SELECT * FROM products WHERE product_id IN (15, 16, 17, 18) OR product_id BETWEEN 6 AND 11 ORDER BY FIELD(product_id, 15, 16, 17, 18, 6, 7, 8, 9, 10, 11)"; 
